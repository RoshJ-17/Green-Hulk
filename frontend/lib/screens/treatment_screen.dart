...
class _TreatmentScreenState extends State<TreatmentScreen> {
  ...
  bool organicOnlyMode = false; // Organic Only toggle
  bool speaking = false;
  int rating = 0;
  ...
  Future<void> _shareTreatmentPlan() async {
    ...
    final treatmentType = showOrganicTreatment ? 'Organic' : 'Chemical';
    final treatment = showOrganicTreatment ? organicTreatment : chemicalTreatment;
    final steps = treatment['steps'] as List<Map<String, dynamic>>;
...
Disease: ${AIModelService.getDiseaseDisplayName(result)}
...
''';
  ...
  Widget build(BuildContext context) {
    ...
    // If organicOnlyMode is on, always show organic treatment
    final treatment = (organicOnlyMode || showOrganicTreatment) 
        ? organicTreatment 
        : chemicalTreatment;
    final steps = treatment['steps'] as List<Map<String, dynamic>>;
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  /// Confidence percentage display (prominent)
                  Container(
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Icon(Icons.eco, color: AppTheme.organicGreen),
                  ...
                  Switch(
                    ...
                    activeColor: AppTheme.organicGreen,
                    onChanged: (value) {
                      AudioService.playButtonClick();
                      setState(() {
                        organicOnlyMode = value;
                        if (value) showOrganicTreatment = true;
                      });
                    },
                  ),
                ],
                ...
                children: [
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: organicOnlyMode ? null : () {
                        AudioService.playButtonClick();
