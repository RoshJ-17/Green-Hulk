...
export class QualityCheckerService {
  ...
  constructor(
    ...
    this.BLUR_THRESHOLD = configService.get<number>("BLUR_THRESHOLD") || 100.0;
    this.MIN_BRIGHTNESS = configService.get<number>("MIN_BRIGHTNESS") || 50.0;
    this.MAX_BRIGHTNESS = configService.get<number>("MAX_BRIGHTNESS") || 200.0;
  }
  ...
  async checkImageQuality(
    ...
    // Check 3: Resolution
    if (
      metadata.width < this.MIN_RESOLUTION ||
