...
describe('DiagnosisController', () => {
    ...
    beforeEach(async () => {
        ...
        diagnosisService = module.get(DiagnosisService) as jest.Mocked<DiagnosisService>;
        supportedClasses = module.get(SupportedClassesService) as jest.Mocked<SupportedClassesService>;
    });
